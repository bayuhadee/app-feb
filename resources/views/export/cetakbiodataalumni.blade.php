...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="font-family:Calibri; font-size:14px" onload="doPrint()">
    ...
    <table width="100%" border="0">
      ...
      <tr>
        <td align="center" style="font-size:16px"><strong>EKONOMI UNIVERSITAS WARMADEWA</strong></td>
      </tr>
      <tr>
        <td align="center" style="border-bottom:#000 1px solid; font-size:16px"><strong>(I K A D E W A)</strong></td>
      </tr>
      <tr>
        <td align="center" style="font-size:18px"><strong>BIODATA ALUMNI</strong></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
    </table>
    <div align="center"><img src="{{ filter_var($data->foto_biodata, FILTER_VALIDATE_URL) ? $data->foto_biodata : asset('storage/' . $data->foto_biodata) }}" style="width:143px; height:211px"></div>
